...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 500000 * (10**9); // user must hold 2100000 token
...
contract SANTAWAR is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Santas War NFT Epic";
    string constant _symbol = "SANTAWAR";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal permit(sender) returns (bool) {
